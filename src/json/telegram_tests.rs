...
#[test]
fn loading_2020_01() {
    let dao = verify_result(parse_file(resource("telegram_2020-01").as_str()));
...
#[test]
fn loading_2021_05() {
    let dao = verify_result(parse_file(resource("telegram_2021-05").as_str()));
...
#[test]
fn loading_2021_07() {
    let dao = verify_result(parse_file(resource("telegram_2021-07").as_str()));
